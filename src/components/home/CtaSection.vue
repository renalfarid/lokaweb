          ...
          <div class="items-center gap-x-12 sm:px-4 md:px-0 lg:flex">
              ...
              <div class="max-w-xl px-4 space-y-3 mt-6 sm:px-0 md:mt-0 lg:max-w-2xl">
                  ...
                  <p class="text-gray-800 text-3xl font-semibold sm:text-4xl">
                    Coding untuk Generasi Masa Depan
                  </p>
                  <p class="mt-3 text-gray-600">
                    Bersama Loka Academy, mari temukan bagaimana coding menjadi fondasi untuk meretas batasan dan menciptakan masa depan yang cerah untuk generasi yang penuh semangat ini
                  </p>
